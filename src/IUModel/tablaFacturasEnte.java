 ...
 * @author victo
 */
public class tablaFacturasEnte  extends AbstractTableModel implements TableModel {

    private final Class[] tipoColumnas;
    private final String[] titleColumnas;
    private List<factura> almacen;

    public tablaFacturasEnte() {
        this.titleColumnas = new String[]{"N/Registro", "N/Factura","Descripcion", "monto", "Fecha"};
        this.tipoColumnas = new Class[]{Integer.class, Integer.class, String.class,  Float.class,  String.class};
     ...
     * @param al
     */
    public void setalmacen(List<factura> al) {
        this.almacen = al;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                return almacen.get(rowIndex).getDescriccion();
            case 3:
                return almacen.get(rowIndex).getMonto();
            case 4:
                return  almacen.get(rowIndex).getFecha();
            default:
                return null;
        }
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                almacen.get(rowIndex).setDescriccion(aValue.toString());
            case 3:
