 ...
 * @author victo
 */
public class tablaClientes extends AbstractTableModel implements TableModel {
    

    private final  Class[] tipoColumnas;
    private final  String[] titleColumnas;
    private List<Entidades> almacen;
    
    
    public tablaClientes() {
        this.titleColumnas = new String[]{"RIF/Cedula", "Nombre"};
     ...
     * @param al
     */
    public void setalmacen(List<Entidades> al) {
        this.almacen = al;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case 0:
                return almacen.get(rowIndex).getRif();
            case 1:
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex){
        ...
        switch (columnIndex) {
            case 0:
                 almacen.get(rowIndex).setRif(aValue.toString());
                 break;
            case 1:
