 ...
 * @author victo
 */
public class tablaAjustes extends AbstractTableModel implements TableModel {

    private Class[] tipoColumnas;
    private String[] titleColumnas;
    private List<Ajustes> almacen;

    public tablaAjustes() {
        this.titleColumnas = new String[]{"Registro", "Descripcion", "cantidad", "Precio/U", "Fecha"};
     ...
     * @param al
     */
    public void setalmacen(List<Ajustes> al) {
        this.almacen = al;
    }
